...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:yn,depthTest:!1,depthWrite:!1})}function So(){return new Vn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ea(),fragmentShader:`
		...
		`,blending:yn,depthTest:!1,depthWrite:!1})}function Eo(){return new Vn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ea(),fragmentShader:`
...
#define LOW_PRECISION`),e}function Zp(r){let e="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===dc?e="SHADOWMAP_TYPE_PCF":r.shadowMapType===hl?e="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===on&&(e="SHADOWMAP_TYPE_VSM"),e}function $p(r){let e="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case _i:case xi:e="ENVMAP_TYPE_CUBE";break;case zr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Jp(r){let e="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case xi:e="ENVMAP_MODE_REFRACTION";break}return e}function Qp(r){let e="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case fc:e="ENVMAP_BLENDING_MULTIPLY";break;case Nl:e="ENVMAP_BLENDING_MIX";break;case Ol:e="ENVMAP_BLENDING_ADD";break}return e}function em(r){const e=r.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function tm(r,e,t,n){const i=r.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=Zp(t),l=$p(t),u=Jp(t),h=Qp(t),d=em(t),m=t.isWebGL2?"":kp(t),g=Vp(s),_=i.createProgram();let p,f,T=t.glslVersion?"#version "+t.glslVersion+`
